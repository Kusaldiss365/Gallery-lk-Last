...
<?php 
    ...
    if($check_ad){
        while($row = mysqli_fetch_assoc($query)){
            $adID = $row['ad_id']; 
?>
           <option value="<?php echo $adID; ?>" type="text" name="id" class="id"><?php echo $adID; ?></option>
<?php
        }}
?>          </td></tr>
            <tr></tr>
            <tr>
            <td>
            <textarea name="message" placeholder="Enter your Complain here" rows="15" cols="30"></textarea> <br>
            </td>
            </tr>
            </table>
