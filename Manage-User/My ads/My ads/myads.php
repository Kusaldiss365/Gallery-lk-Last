        ...
        <div class="profile">
            ...
            <div class="body">
                <div class="inner">
                        ...
                        <div class="box1">
                            <div class="image"><img src="../Src/1.jpg" alt="" class="itms"></div>
                            <div class="text"><b>ABC</b><br><b>catagory:</b>Oil paint<br><b>Price:</b>Rs.2000.00</div>
                            <div class="btn">
                                <div><button type="button"  class="btn1">Edit Ads</button></div>
                                <div><button type="button"  class="btn2">Remove Ads</button></div>
                            </div>
                        </div>
                        <div class="box1">
                            <div class="image"><img src="../Src/2.jpg" alt="" class="itms" ></div>
                            <div class="text"><b>ABC</b><br><b>catagory:</b>Oil paint<br><b>Price:</b>Rs.2000.00</div>
                            <div class="btn">
                                <div><button type="button"  class="btn1">Edit Ads</button></div>
                                <div><button type="button"  class="btn2">Remove Ads</button></div>
